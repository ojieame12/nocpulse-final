...
function moistureColor(pct: number): string {
  if (pct < 30) return 'var(--status-danger)';
      ...
      <div className="panel__body panel__body--gap-20">
        ...
        <div className="cell-inspector__donut-wrap">
          <DonutChart
            ...
            size={140}
            color={moistureColor(rootMoisture)}
          />
        </div>
        ...
        <div className="cell-inspector__stat-row">
          <div className="cell-inspector__stat-tile">
            ...
            <span className="cell-inspector__stat-value">{rootMoisture}%</span>
          </div>
          <div className="cell-inspector__stat-tile">
            <span className="cell-inspector__stat-label">Surface</span>
            <span className="cell-inspector__stat-value">{surfaceMoisture}%</span>
          </div>
        </div>
        ...
        <div className="panel__data-section">
          ...
          <div className="cell-inspector__comparison-row">
            ...
            <span className="cell-inspector__comparison-cell cell-inspector__comparison-cell--negative">
              {delta.toFixed(1)}%
            </span>
          </div>
        </div>
              ...
              <div key={i} className="cell-inspector__bar-col">
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: moistureColor(d.value),
                  }}
                />
          ...
          <div className="cell-inspector__neighbors-grid">
            {NEIGHBORS.map((n) => (
              ...
              >
                ...
                <span className="cell-inspector__neighbor-val">{n.value}%</span>
              </div>
            ))}
          </div>
        </div>
