...
begin
  ...
  select
    ranked_snapshot.target_field_id,
    ranked_snapshot.source_workspace_id,
    ranked_snapshot.source_field_id,
    ranked_snapshot.source_snapshot_id,
    ranked_snapshot.observed_at,
    ranked_snapshot.source_key
  from (
    select
      source_candidate.target_field_id,
      source_candidate.source_workspace_id,
  ...
  where ranked_snapshot.snapshot_rank = 1;
